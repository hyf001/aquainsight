...
export const routeConfig: Record<string, RouteConfig> = {
  ...
  '/task': { path: '/task', label: '任务调度' },
  '/task-execution': { path: '/task-execution', label: '任务' },
  ...
  '/step-templates': { path: '/step-templates', label: '步骤模版' },
  '/taskTemplates': { path: '/taskTemplates', label: '任务模版' },
  '/site-configuration': { path: '/site-configuration', label: '站点任务调度' },
